...
const hash_lock_1 = require("../hash-lock");
const time_locks_1 = require("../time-locks");
...
class Immutables {
    ...
    static fromJSON(data) {
        ...
        const TypedAddress = isSolanaAddress ? addresses_1.SolanaAddress : addresses_1.EvmAddress;
        return new Immutables((0, bytes_1.bufferFromHex)(data.orderHash), hash_lock_1.HashLock.fromString(data.hashlock), TypedAddress.fromBuffer((0, bytes_1.bufferFromHex)(data.maker)), TypedAddress.fromBuffer((0, bytes_1.bufferFromHex)(data.taker)), TypedAddress.fromBuffer((0, bytes_1.bufferFromHex)(data.token)), BigInt(data.amount), BigInt(data.safetyDeposit), time_locks_1.TimeLocks.fromBigInt(BigInt(data.timelocks)));
    }
    toJSON() {
        return this.build();
    }
