...
class EvmAddress {
    ...
    static fromUnknown(address) {
        if (typeof address === 'string') {
            ...
            if ((0, is_bigint_string_1.isBigintString)(address)) {
    ...
    toBuffer() {
        return (0, bytes_1.bufferFromHex)(this.toString());
    }
    toHex() {
    ...
    splitToParts() {
        return [address_complement_1.AddressComplement.ZERO, this];
    }
}
exports.EvmAddress = EvmAddress;
EvmAddress.ZERO = new EvmAddress(fusion_sdk_1.Address.ZERO_ADDRESS);
EvmAddress.NATIVE = new EvmAddress(fusion_sdk_1.Address.NATIVE_CURRENCY);
