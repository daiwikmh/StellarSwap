 ...
 * ^deployedAt
 */
class SrcTimeLocks extends base_time_lock_1.BaseTimeLock {
     ...
     */
    isFinalityLock(time = BigInt((0, time_1.now)())) {
     ...
     * @param time default is `now()`
     */
    isPrivateWithdrawal(time = BigInt((0, time_1.now)())) {
     ...
     * @param time default is `now()`
     */
    isPublicWithdrawal(time = BigInt((0, time_1.now)())) {
     ...
     * @param time default is `now()`
     */
    isPrivateCancellation(time = BigInt((0, time_1.now)())) {
     ...
     * @param time default is `now()`
     */
    isPublicCancellation(time = BigInt((0, time_1.now)())) {
        return time >= this.publicCancellation;
    }
    getStage(time = BigInt((0, time_1.now)())) {
