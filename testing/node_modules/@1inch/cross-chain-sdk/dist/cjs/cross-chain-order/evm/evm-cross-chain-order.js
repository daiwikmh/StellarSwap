...
const inner_order_1 = require("./inner-order");
const escrow_extension_1 = require("./escrow-extension");
const address_complement_1 = require("../../domains/addresses/address-complement");
...
class EvmCrossChainOrder extends base_order_1.BaseOrder {
    ...
    get maker() {
        return addresses_1.EvmAddress.fromString(this.inner.maker.toString());
    }
    get takerAsset() {
        return (0, addresses_1.createAddress)(this.inner.escrowExtension.dstToken.toString(), this.dstChainId);
    }
    get makerAsset() {
        return addresses_1.EvmAddress.fromString(this.inner.makerAsset.toString());
    }
    get takingAmount() {
     ...
     */
    get receiver() {
        return (0, addresses_1.createAddress)(this.inner.receiver.toString(), this.dstChainId, this.escrowExtension.dstAddressFirstPart);
    }
    /**
     * Timestamp in sec
     */
    ...
    static new(escrowFactory, orderInfo, escrowParams, details, extra) {
        (0, assert_1.default)((0, chains_1.isEvm)(escrowParams.srcChainId), `Not supported chain ${escrowParams.srcChainId}`);
        ...
        const postInteractionData = fusion_sdk_1.SettlementPostInteractionData.new({
            ...
            resolvingStartTime: details.resolvingStartTime ?? BigInt((0, time_1.now)())
        });
        if (!(0, chains_1.isEvm)(escrowParams.dstChainId) && !orderInfo.receiver) {
            throw new Error('Receiver is required for non EVM chain');
        }
        const [complement, receiver] = orderInfo.receiver?.splitToParts() || [
            address_complement_1.AddressComplement.ZERO,
            addresses_1.EvmAddress.ZERO
        ];
        const ext = new escrow_extension_1.EscrowExtension(escrowFactory, details.auction, postInteractionData, extra?.permit
        ...
        return new EvmCrossChainOrder(ext, {
            ...orderInfo,
            receiver,
            takerAsset: deployments_1.TRUE_ERC20[escrowParams.srcChainId]
        }, extra);
    }
    /**
    ...
    static fromDataAndExtension(order, extension) {
        const ext = escrow_extension_1.EscrowExtension.fromExtension(extension);
        ...
        return new EvmCrossChainOrder(ext, {
            makerAsset: addresses_1.EvmAddress.fromString(order.makerAsset),
            takerAsset: addresses_1.EvmAddress.fromString(order.takerAsset),
            makingAmount: BigInt(order.makingAmount),
            takingAmount: BigInt(order.takingAmount),
            receiver: addresses_1.EvmAddress.fromString(order.receiver),
            maker: addresses_1.EvmAddress.fromString(order.maker),
    ...
    getOrderHashBuffer(srcChainId) {
        return (0, bytes_1.bufferFromHex)(this.getOrderHash(srcChainId));
    }
