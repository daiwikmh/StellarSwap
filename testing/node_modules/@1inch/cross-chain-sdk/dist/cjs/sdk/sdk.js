...
class SDK {
    ...
    async getQuote(params) {
        const quoteParams = {
            ...
            walletAddress: params.walletAddress || addresses_1.EvmAddress.ZERO.toString(),
        ...
        if (api_1.QuoterRequest.isEvmRequest(quoteParams)) {
            const req = api_1.QuoterRequest.forEVM(quoteParams);
            return this.api.getQuote(req);
        }
        if (api_1.QuoterRequest.isSolanaRequest(quoteParams)) {
            const req = api_1.QuoterRequest.forSolana(quoteParams);
            return this.api.getQuote(req);
        }
    ...
    async createOrder(quote, params) {
        ...
        (0, assert_1.default)(quote.isEvmQuote(), 'cannot use non-evm quote');
        const order = quote.createEvmOrder({
            hashLock: params.hashLock,
            receiver: params.receiver
                ? addresses_1.EvmAddress.fromString(params.receiver)
                : undefined,
