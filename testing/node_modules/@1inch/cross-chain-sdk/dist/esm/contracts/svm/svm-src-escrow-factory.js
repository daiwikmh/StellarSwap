...
import { AuctionDetails, EvmAddress, HashLock, SolanaAddress, TimeLocks } from '../../domains';
...
export class SvmSrcEscrowFactory extends BaseProgram {
    ...
    static parseCreateInstruction(ix) {
        ...
        const extraDetails = {
            ...
            resolverCancellationConfig: new ResolverCancellationConfig(BigInt(data.maxCancellationPremium), data.cancellationAuctionDuration),
...
SvmSrcEscrowFactory.DEFAULT = new SvmSrcEscrowFactory(new SolanaAddress('2g4JDRMD7G3dK1PHmCnDAycKzd6e5sdhxqGBbs264zwz'));
SvmSrcEscrowFactory.coder = new BorshCoder(IDL);
