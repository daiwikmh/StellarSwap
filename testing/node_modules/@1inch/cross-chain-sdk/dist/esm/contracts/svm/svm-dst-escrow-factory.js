...
import { EvmAddress, HashLock, SolanaAddress, TimeLocks } from '../../domains';
...
SvmDstEscrowFactory.DEFAULT = new SvmDstEscrowFactory(new SolanaAddress('GveV3ToLhvRmeq1Fyg3BMkNetZuG9pZEp4uBGWLrTjve'));
SvmDstEscrowFactory.coder = new BorshCoder(IDL);
