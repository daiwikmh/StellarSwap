...
import { FusionExtension, Extension, ZX } from '@1inch/fusion-sdk';
...
import { EvmAddress, createAddress } from '../../domains/addresses';
/**
...
export class EscrowExtension extends FusionExtension {
    ...
    constructor(address, auctionDetails, postInteractionData, makerPermit, hashLockInfo, dstChainId, dstToken, srcSafetyDeposit, dstSafetyDeposit, timeLocks, dstAddressFirstPart = AddressComplement.ZERO) {
    ...
    static fromExtension(extension) {
        ...
        return new EscrowExtension(EvmAddress.fromString(fusionExt.address.toString()), AuctionDetails.fromBase(fusionExt.auctionDetails), fusionExt.postInteractionData, fusionExt.makerPermit, extra.hashLock, extra.dstChainId, extra.dstToken, extra.srcSafetyDeposit, extra.dstSafetyDeposit, extra.timeLocks, complement);
    }
    /**
