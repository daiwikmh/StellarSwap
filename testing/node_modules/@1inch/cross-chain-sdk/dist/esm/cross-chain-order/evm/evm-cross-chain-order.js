...
import { createAddress, EvmAddress } from '../../domains/addresses';
import { BaseOrder } from '../base-order';
import { TRUE_ERC20 } from '../../deployments';
import { isEvm, isSupportedChain } from '../../chains';
...
export class EvmCrossChainOrder extends BaseOrder {
     ...
     */
    get receiver() {
        return createAddress(this.inner.receiver.toString(), this.dstChainId, this.escrowExtension.dstAddressFirstPart);
    }
    /**
     * Timestamp in sec
     */
